...
Test action: started the host server on `http://SERVER_IP:8765`, copied the agent to `/mnt/us/privatecloud/kindle-agent.sh`, then ran `init`, `sync`, `list`, and `download` on the Kindle.
